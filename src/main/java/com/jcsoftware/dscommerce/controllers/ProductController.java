...
public class ProductController {
	...
	@GetMapping
	public ResponseEntity<Page<ProductMinDTO>> findAll(@RequestParam(defaultValue="") String name,@RequestParam(defaultValue="0") String categoryId,Pageable pageable){
